#split peaks not near TSSs into 20 bins across chromosomes
#1. read TSS file, chromosome size file, centromere position file
#2. split chromosome into bins
#3. count the number of peaks near TSS in each bin
#4. write output to file
#to run script: python3 MakeBins_peaksnotatTSSs.py <peaks not at TSSs> <chr num> <centromere positions file> <Chr length file> <output file>
