...
#to run script: python3 MakeBins_peaksnearTSS_atac.py <peaks at TSSs with exp file> <chr num> <centromere positions file> <Chr length file> <output file>
...
def write():
    ...
    with open(output,'a') as out:
        header = "Bin.Num\tBin.Start\tBin.End\tNumber.TSS\n"
        out.write(header)
        x = 0
        while x < 20:
            if x in arm1_dict:
